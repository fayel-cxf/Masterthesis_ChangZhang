...
ESR_PATH = BASE_DIR / 'data' / 'ecoprov_envdist_scaled.csv'
REG_PATH = BASE_DIR / 'quantitative risk framework' / 'dwt_log_fit' / 'data' / 'log_regression_results.csv'
SEA_PATH = BASE_DIR / 'data' / 'sea_distance_matrix.pkl'
